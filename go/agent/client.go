...
// BuildRedemption constructs the redemption envelope. Tests hand these bytes
// to a signer directly.
func BuildRedemption(ident *Identity, cap Capability, sshLine string, now time.Time) (protocol.RedemptionRequest, error) {
	...
	// The proof authorizes issuance. The secret never touches the network.
